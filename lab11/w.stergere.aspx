<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w.stergere.aspx.cs" Inherits="lab11.WebForm9" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:AccessDataSource ID="ADS1" runat="server" DataFile="~/App_Data/BDC.accdb" 
             ...
             UpdateCommand="UPDATE [Localitati] SET [DenumireLocalitate] = ?, [NrLocuitori] = ?, [Judet] = ? WHERE [IdLocalitati] = ?">
            <DeleteParameters>
        ...
        <asp:AccessDataSource ID="ADS2" runat="server" DataFile="~/App_Data/BDC.accdb" 
     SelectCommand="SELECT [Data], [CodPostal], [IdLocalitate] FROM [T1]" >
</asp:AccessDataSource>
        <asp:Label ID="Label1" runat="server" Text="Localitati"></asp:Label>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        DataKeyNames="IdLocalitate" DataSourceID="ADS1">
        <Columns>
        ...
        <asp:Label ID="Label2" runat="server" Text="Informati"></asp:Label>
        <asp:Button ID="Button1" runat="server" Text="Sterge " style="position:absolute; 
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84"
             ...
             DataKeyNames="Data,CodPostal,IdLocalitate" DataSourceID="ADS2">
            <Columns>
              <asp:BoundField DataField="Data" HeaderText="Data" ReadOnly="True" SortExpression="Data" />
              <asp:BoundField DataField="CodPostal" HeaderText="CodPostal" ReadOnly="True" 
         ...
         <asp:Panel ID="Panel1" runat="server" style="position :absolute; top: 117px; left: 507px; 
             ...
             <asp:Label ID="Label3" runat="server" Text="Confirmati stergerea Localitati" 
